...
coef_df15 <- reg(Ret ~ PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + PC11 + PC12 + PC13 + PC14 + PC15, merge_data)
coef_df16 <- reg(Ret ~ PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + PC11 + PC12 + PC13 + PC14 + PC15+ PC16, merge_data)
coef_df17 <- reg(Ret ~ PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + PC11 + PC12 + PC13 + PC14 + PC15+ PC16+ PC17, merge_data)
coef_df18 <- reg(Ret ~ PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + PC11 + PC12 + PC13 + PC14 + PC15+ PC16+ PC17+ PC18, merge_data)
coef_df19 <- reg(Ret ~ PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + PC11 + PC12 + PC13 + PC14 + PC15+ PC16+ PC17+ PC18+ PC19, merge_data)
...
for (i in unique(ETF$ETF_code)) {
  ...
  list1 <- list()
  for (j in paste0('coef_df', c(4:19))) {
